...
# include <pthread.h>
# include <sys/time.h>
# include <stdatomic.h> // Optional if using atomic flags
...
typedef struct s_diningTable
{
    ...
    atomic_int              is_full; // Using atomic for simplicity
    atomic_int              dead;     // Using atomic for simplicity
    size_t                  start_time;
    t_philosopher           *philosophers;
    pthread_mutex_t         print_lock;
    pthread_mutex_t         check_lock;
    pthread_cond_t          termination_cond; // Optional
}   t_diningTable;
